function [ depths, times ] = DropBall(diameterBall, densityBall)
...
nominalG = 9.80665;
    ...
    function[flows] = dropFun(~, stocks)
        ...
        densityWater = 1000;%getDensity(depth);
        r = rEarth - depth;
        g = (rEarth/r)^2 * nominalG;
        area = pi * radius^2;
        volumeBall = (4/3) * pi * radius^3;
        massBall = densityBall * volumeBall;
...
[times, depths] = ode45(@dropFun, [0,60], [0,0],options);
end
